...
#define __RAISE_ROW2_LEFT__  _______, XXXXXXX, KC_MINS, KC_PLUS, KC_EQL,  XXXXXXX
#define __RAISE_ROW2_RIGHT__ XXXXXXX, KC_4,    KC_5,    KC_6,    XXXXXXX, _______

#define __RAISE_ROW3_LEFT__  _______, XXXXXXX, KC_SLSH, KC_ASTR, XXXXXXX, XXXXXXX
#define __RAISE_ROW3_RIGHT__ XXXXXXX, KC_1,    KC_2,    KC_3,    KC_DOT,  _______
...
#define __ADJUST_ROW3_RIGHT__ KC_PGDN, KC_END,  KC_HOME, KC_PGUP, XXXXXXX, KC_CAPS
