...
KC_ESCAPE , LSFT(LGUI(KC_MINS)) , LSFT(LGUI(KC_PLUS)) , KC_PSCR , LGUI(KC_L)    ,
...
KC_EQL  , ___________________XXXXX___________________ , QK_REBOOT   ,
...
KC_LEFT_CTRL,       KC_U,           KC_F4,          KC_M,           KC_R,
