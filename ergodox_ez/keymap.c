...
[_QWERTY] = LAYOUT_ergodox(
  ...
  _______, KC_N,    KC_M,    KC_COMM, KC_DOT,  LOW(SLSH),KC_SFTENT,
...
[_LOWER] = LAYOUT_ergodox(
  ...
  _______, _______, KC_LBRC, KC_RBRC, KC_PIPE, XXXXXXX, _______,
  ...
  _______, XXXXXXX, KC_BSLS, KC_LT,   KC_GT,   _______, _______,
